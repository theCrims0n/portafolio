        ...
        return (
            <input
                ...
                className={clsx(
                    ...
                    type === "file" &&
                    "placeholder-gray-300 file:text-white placeholder-opacity-75 p-0 pr-3 italic  file:me-3 file:h-full file:border-0 file:border-r file:border-solid file:border-input file:bg-zinc-950 file:px-3 file:text-sm file:font-medium file:not-italic focus:bg-purple-800",
                    className,
                )}
                ref={ref}
                {...props}
